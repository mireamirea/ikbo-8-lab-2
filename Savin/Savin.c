...
#define INIT_SIZE 5		/* Initial size of Memory Tape */
#define INCREASE 3		/* Increase of tape */


struct machine {
	
	int *memoryTape;
	long long int size;			/* Conditionally infinited */
	int *position;
	long long int mem;			/* Conditionally infinited */
	
} Turing;


int sizeFPOS = 1;		/* Size of variable, essential for functions begin & end */
...
int main () {
	...
	FILE *fp;
	char str[255];
	int *fpos;			/* This variable is using in the functions begin & end */
